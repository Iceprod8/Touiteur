...
export type ResolversTypes = {
  ...
  CRUserResponse: ResolverTypeWrapper<Omit<CrUserResponse, 'user'> & { user?: Maybe<ResolversTypes['User']> }>;
...
export type ResolversParentTypes = {
  ...
  CRUserResponse: Omit<CrUserResponse, 'user'> & { user?: Maybe<ResolversParentTypes['User']> };
